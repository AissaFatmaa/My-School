...
import { editclub } from "../JS/clubSlice";
function EditClub({ ping, setping, el }) {
    ...
    <>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Editer Club</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3" controlId="formBasicEmail">
              ...
              <Form.Control
                type="text"
                placeholder={el?.name_club}
                onChange={(e) =>
                  setedit({ ...edit, name_club: e.target.value })
                }
              />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Modal.Footer>
          ...
          <Button
            variant="primary"
            onClick={() => {
              dispatch(editclub({ id: el?._id, edit }));
              setping(!ping);
              handleClose();
            }}
          >
