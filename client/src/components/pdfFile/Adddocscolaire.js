...
function Adddocscolaire({reload, setreload}) {
  ...
  const [category, setcategory] = useState("doc_teacher_scolaire");
     ...
     <>
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        ...
        <div>
          ...
          <option value="devoir">Dévoirs</option>
            <option value="fichenote">Fiche de note</option>
            <option value="ficheabs">Fiche d'abscence</option>
            <option value="fichecontrat">Fiche contrat</option>
